...
function buildSteps(a: AccountStatus | null): TourStep[] {
  ...
  return [
    ...
    { id: 'session', screen: 'today', target: 'session', title: 'Your active task', text: 'The timer counts active time only: it pauses when you step away, lock the screen or sleep, and resumes when you are back. Press Stop when you are done and say how it went; that becomes an entry.' },
