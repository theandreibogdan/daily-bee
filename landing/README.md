...
1. **Set the repository address** in [`config.js`](config.js). Every GitHub, Releases and Issues link is built from it; until it is set the site shows a note in the open-source section.
